<?php
    ...
    {
        $sql = "INSERT INTO appointments(dateofbooking,timeofbooking,user_id)
        VALUES(:dateofbooking,:timeofbooking,:user_id)";
        ...
        $statement->bindParam(":user_id",$_SESSION['id'],PDO::PARAM_STR);
...
<html lang="en">
    <head>
        ...
        <title>Book An Appointment| Smadico </title>
    ...
    <body style="background-color: black;">
        ...
        <div class="BookingTemplate">
            ...
            <form method="post">
                ...
                <button type="submit" class="SubmitBooking"> Submit </button>
        ...
        <footer>
            ...
            <div class="FooterCategories">
                ...
                <h3 class="FooterH3"> Categories </h3>
